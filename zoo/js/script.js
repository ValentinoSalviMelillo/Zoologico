...
zoo.agregarAnimal("Tigre", 5, 1, 150); 
zoo.agregarAnimal("León", 2, 1, 180); 
zoo.agregarAnimal("Águila", 3, 2, 2); 
zoo.agregarAnimal("Serpiente", 4, 3, 80); 
zoo.agregarAnimal("Pantera", 5, 1, 100); 
